...
from src.nodes.mechanical_nodes import (
    MechanicalExpertState,
    step1_node,
    step2_node,
    step3_node
)
...
def mechanical_expert_wrapper_node(state: InvestigationState) -> Dict[str, Any]:
    ...
    try:
        ...
        step1_result = final_state.get("mechanical_step1_result") or {}
        step2_result = final_state.get("mechanical_step2_result") or {}
        step3_result = final_state.get("mechanical_step3_result") or {}
